...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_99 = Integer(99); _sage_const_9 = Integer(9); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_3 = Integer(3)
class Lattice():
...
v = [vector(randint(-_sage_const_99 ,_sage_const_99 ) for _ in range(_sage_const_9 )) for _ in range(_sage_const_5 )]
L = Lattice(v)
pi2 = L.pi_t[_sage_const_2 ]
zeta2 = L.zeta_t[_sage_const_2 ]
w = vector(randint(-_sage_const_9 ,_sage_const_9 ) for _ in range(_sage_const_9 ))
